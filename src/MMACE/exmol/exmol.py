...
from .data import *
from ...core.fingerprints import Fingerprints
...
def run_stoned(
    ...
    #TODO: in the future use any fingerprint type from scikit-fingerprints
    base_fp = stoned.get_fingerprint(start_mol, fp_type=fp_type)
    fps = [stoned.get_fingerprint(m, fp_type) for m in filter_mols]
    scores = BulkTanimotoSimilarity(base_fp, fps)  # type: List[float] #TODO: add different measures for different fingerprints??
