...
class Models:
    ...
    def get_model(self, name: str, model_path: str | None = None) -> tuple:
        ...
        :return: "proper" model name, model and a parameter grid, and a function for feature importance calculation if available.
        """
        if name in self._models:
            ...
            model, params, f_importance, dict_name = self._models[name]()
            return dict_name, model, params, f_importance
...
def _get_xgboost() -> tuple:
    ...
    f_importance = lambda model: model.feature_importances_
    return xgb, xgb_params, f_importance, "XGBoost Regressor"
...
def _get_rf() -> tuple:
    ...
    f_importance = lambda model: model.feature_importances_
    return rf, rf_params, f_importance, "Random Forest Regressor"
